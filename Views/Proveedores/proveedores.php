...
<div class="main-container">
	<div class="pd-ltr-20 xs-pd-20-10">
		...
		<div class="pd-20 card-box mb-30">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="rtnempresa" value="-" id="rtnempresa" th:field="*{rtnempresa}" maxlength="14" minlength="14" pattern="[0-9]+">
							<div class="valid-feedback">Valido</div>
							<div class="invalid-feedback">Por favor, rellena el campo</div>
			...
			<input type="text" class="form-control" required name="correo" id="correo" minlength="10" maxlength="40" pattern="[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9- ]+(?:\.[a-zA-Z0-9-]+)*$]+">
			<div class="valid-feedback">Valido</div>
            <div class="invalid-feedback">Por favor, rellena el campo</div>
			</div>
			</div>
