                    ...
                    <form class="needs-validation" id="formEditarEmpleado" name="formEditarEmpleado" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control " type="text" value="<?= $empleado['nom_persona'] ?>" id="nombreEmpleado" name="nombreEmpleado" required required pattern="^[A-Za-z ]*$">
                                    <span class="msj"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " id="identidad" value="<?= $empleado['num_id_persona'] ?>" name="identidad" required required pattern="[0-9]+">
                                    <span class="msj"></span>
                                    <div class="valid-feedback">Valido</div>
                                    <div class="invalid-feedback">Por favor, rellena el campo</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control " value="<?= $empleado['correo'] ?>" id="correo" name="correo" required>
                                    <span class="msj"></span>
                                    <div class="valid-feedback">Valido</div>
                                    <div class="invalid-feedback">Por favor, rellena el campo</div>
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " value="<?= $empleado['ape_persona'] ?>" id="apellido" name="apellido" required required pattern="^[A-Za-z ]*$">
                                    <span class="msj"></span>
                                    <div class="valid-feedback">Valido</div>
                                    <div class="invalid-feedback">Por favor, rellena el campo</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control " value="<?= $empleado['eda_persona'] ?>" id="edad" name="edad" required required pattern="[0-9]+">
                                    <span class="msj"></span>
                                    <div class="valid-feedback">Valido</div>
                                    <div class="invalid-feedback">Por favor, rellena el campo</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " value="<?= $empleado['telefono'] ?>" id="telefono" name="telefono" required required pattern="[0-9]+">
                                    <span class="msj"></span>
                                    <div class="valid-feedback">Valido</div>
                                    <div class="invalid-feedback">Por favor, rellena el campo</div>
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="direccion" id="direccion" cols="30" rows="10" style="resize:vertical; height: 140px;" required required pattern="^[A-Za-z ]*$"><?= $empleado['direccion'] ?></textarea>
                                    <span class="msj"></span>
                                    <div class="valid-feedback">Valido</div>
                                    <div class="invalid-feedback">Por favor, rellena el campo</div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " value="<?= $empleado['sal_empleado'] ?>" id="salario" name="salario" required required pattern="[0-9]+">
                                    <span class="msj"></span>
                                    <div class="valid-feedback">Valido</div>
                                    <div class="invalid-feedback">Por favor, rellena el campo</div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-md-offset-2">
                                <button type="submit" class="btn btn-primary float-right" name="GuardarEmpleado">Actualizar</button>
                            </div>
                        </div>
                    </form>
